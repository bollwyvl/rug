...
class Repo(object):
	...
	def fetch(self, remote=None):
		"""
		TODO: repo Project doesn't currently support fetching a particular
			source
		"""
		self.project.fetch()
	...
	def push(self, remote, branch, force):
		"""
		TODO: this is a hack to drop the branch and force args, because rug
			repos don't handle them. Fix
		"""
